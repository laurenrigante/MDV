...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      "hover:text-[#8CC63F] transition duration-300 ease-in-out",
      className
    )}
    {...props}
  >
    <Globe className="h-4 w-4 text-muted-foreground text-[#8CC63F] mr-2" />
    {children}
...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        "relative z-50 max-h-96  overflow-hidden rounded-md bg-popover text-popover-foreground shadow-md",
        position === "popper" &&
